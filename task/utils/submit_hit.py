...
n_hours_to_complete_hit = .5
n_hours_to_accept_hit = 7
...
def generate_hit_info(context, compensation_amount, i_hits_per_subsubmission): 
    ...
    hit_info['title'] = 'An experiment where you can earn up to $%.02f bonus in less than %d minutes!'%( params['max_bonus'], params['max_time'] + 1)  
